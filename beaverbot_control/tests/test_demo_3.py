...
# @file test_demo_3.py
#
# @brief Provide test demo 3 for trailer tractor system.
#
...
class TestDemo3(object):
    ...
    def test_demo_3(self):
        ...
        rospy.loginfo("Move forward for 2 seconds")
        ...
        rospy.sleep(2.0)
        rospy.loginfo("Avoid the obstacle")
        sampling_time = 0.2
